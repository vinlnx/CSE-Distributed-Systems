 ...
 * visibility of each of the methods/variables are on purpose. This code must be
 * written as a state machine -- each upcall must do its work and return so that
...
public abstract class Node {
     ...
     * tries to catch Exception. The student should NOT try to catch this or
     * Error, Throwable, etc.
     */
     ...
     * of any overriding fail. Overriding this method should only be used for
     * logging purposes, since you are not guaranteed that it will be called for
     * each crash (especially in an emulation)
     */
    public void fail() {
